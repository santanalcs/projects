...
exports.logout = exports.changeLogin = exports.login = void 0;
...
const changeLogin = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (data.password1 && data.password2) {
        password = (data.password1 == data.password2 && data.password != data.password1) ? data.password2 : '';
        if (password == '') {
    ...
    ;
    const user = yield UsersLogin_1.User.findOne({ where: { id: parseInt(req.body.id) } });
    if (!user) {
    ...
    ;
    if (user) {
        const matches = yield bcrypt_1.default.compare(data.password, user.password);
